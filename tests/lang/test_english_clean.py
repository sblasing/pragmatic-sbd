...
<<<<<<< HEAD
    ...
    (
        ...
        [
            "This sentence ends with the psuedo-number x10.",
            "This one with the psuedo-number %3.00.",
            "One last sentence.",
        ],
    ),
    (
    ...
    (
        ...
        [
            "The U.K. Panel on enivronmental issues said it was true.",
    ...
    ("Hello World. \\ r \\ nHello.", ["Hello World.", "Hello."]),
    (
...
<<<<<<< HEAD
        [
            ...
            "There was nothing on it but a tiny golden key, and Alice's first idea was that this might belong to one of the doors of the hall; but, alas! either the locks were too large, or the key was too small, but, at any rate, it would not open any of them.",
            ...
            '"Oh," said Alice, "how I wish I could shut up like a telescope! I think I could, if I only knew how to begin."',
            ...
            '"No, I\'ll look first," she said, "and see whether it\'s marked \'_poison_\' or not," for she had never forgotten that, if you drink from a bottle marked "poison," it is almost certain to disagree with you, sooner or later.',
            'However, this bottle was _not_ marked "poison," so Alice ventured to taste it, and, finding it very nice (it had a sort of mixed flavor of cherry-tart, custard, pineapple, roast turkey, toffy and hot buttered toast), she very soon finished it off.',
            "*       *       *       *       *",
            ...
            "He came trotting along in a great hurry, muttering to himself, \"Oh! the Duchess, the Duchess! Oh! _won't_ she be savage if I've kept her waiting!\"",
            ...
            "Alice took up the fan and gloves and she kept fanning herself all the time she went on talking.",
            "\"Dear, dear! How queer everything is to-day! And yesterday things went on just as usual. _Was_ I the same when I got up this morning? But if I'm not the same, the next question is, 'Who in the world am I?' Ah, _that's_ the great puzzle!\"",
            "As she said this, she looked down at her hands and was surprised to see that she had put on one of the Rabbit's little white kid-gloves while she was talking.",
            '"How _can_ I have done that?" she thought.',
            '"I must be growing small again."',
            "She got up and went to the table to measure herself by it and found that she was now about two feet high and was going on shrinking rapidly.",
            ...
            '"That _was_ a narrow escape!" said Alice, a good deal frightened at the sudden change, but very glad to find herself still in existence.',
            ...
            '"Things are worse than ever," thought the poor child, "for I never was so small as this before, never!"',
            ...
            "The Mouse was bristling all over and she felt certain it must be really offended.",
            ...
            '"Are you--are you fond--of--of dogs? There is such a nice little dog near our house, I should like to show you! It kills all the rats and--oh, dear!" cried Alice in a sorrowful tone.',
            ...
            "When the Mouse heard this, it turned 'round and swam slowly back to her; its face was quite pale, and it said, in a low, trembling voice, \"Let us get to the shore and then I'll tell you my history and you'll understand why it is I hate cats and dogs.\"",
            ...
            'At last the Mouse, who seemed to be a person of some authority among them, called out, "Sit down, all of you, and listen to me! _I\'ll_ soon make you dry enough!"',
            ...
            "First it marked out a race-course, in a sort of circle, and then all the party were placed along the course, here and there.",
            ...
            '"But who is to give the prizes?" quite a chorus of voices asked.',
            '"Why, _she_, of course," said the Dodo, pointing to Alice with one finger; and the whole party at once crowded \'round her, calling out, in a confused way, "Prizes! Prizes!"',
            "Alice had no idea what to do, and in despair she put her hand into her pocket and pulled out a box of comfits (luckily the salt-water had not got into it) and handed them 'round as prizes.",
            ...
            'Some of the birds hurried off at once, and a Canary called out in a trembling voice, to its children, "Come away, my dears! It\'s high time you were all in bed!"',
            "On various pretexts they all moved off and Alice was soon left alone.",
            "\"I wish I hadn't mentioned Dinah! Nobody seems to like her down here and I'm sure she's the best cat in the world!\"",
            "Poor Alice began to cry again, for she felt very lonely and low-spirited.",
            "In a little while, however, she again heard a little pattering of footsteps in the distance and she looked up eagerly.",
            "IV--THE RABBIT SENDS IN A LITTLE BILL",
            'It was the White Rabbit, trotting slowly back again and looking anxiously about as it went, as if it had lost something; Alice heard it muttering to itself, "The Duchess! The Duchess! Oh, my dear paws! Oh, my fur and whiskers! She\'ll get me executed, as sure as ferrets are ferrets! Where _can_ I have dropped them, I wonder?"',
            "Alice guessed in a moment that it was looking for the fan and the pair of white kid-gloves and she very good-naturedly began hunting about for them, but they were nowhere to be seen--everything seemed to have changed since her swim in the pool, and the great hall, with the glass table and the little door, had vanished completely.",
            'Very soon the Rabbit noticed Alice, and called to her, in an angry tone, "Why, Mary Ann, what _are_ you doing out here? Run home this moment and fetch me a pair of gloves and a fan! Quick, now!"',
            '"He took me for his housemaid!" said Alice, as she ran off.',
            ...
            "She hastily put down the bottle, remarking, \"That's quite enough--I hope I sha'n't grow any more.\"",
            "Alas!",
            ...
            "She did not get hold of anything, but she heard a little shriek and a fall and a crash of broken glass, from which she concluded that it was just possible it had fallen into a cucumber-frame or something of that sort.",
            'Next came an angry voice--the Rabbit\'s--"Pat! Pat! Where are you?"',
            'And then a voice she had never heard before, "Sure then, I\'m here! Digging for apples, yer honor!"',
            '"Here! Come and help me out of this! Now tell me, Pat, what\'s that in the window?"',
            '"Sure, it\'s an arm, yer honor!"',
            '"Well, it\'s got no business there, at any rate; go and take it away!"',
            ...
            "At last came a rumbling of little cart-wheels and the sound of a good many voices all talking together.",
            "She made out the words: \"Where's the other ladder? Bill's got the other--Bill! Here, Bill! Will the roof bear?--Who's to go down the chimney?--Nay, _I_ sha'n't! _You_ do it! Here, Bill! The master says you've got to go down the chimney!\"",
            "Alice drew her foot as far down the chimney as she could and waited till she heard a little animal scratching and scrambling about in the chimney close above her; then she gave one sharp kick and waited to see what would happen next.",
            'The first thing she heard was a general chorus of "There goes Bill!" then the Rabbit\'s voice alone--"Catch him, you by the hedge!"',
            'Then silence and then another confusion of voices--"Hold up his head--Brandy now--Don\'t choke him--What happened to you?"',
            'Last came a little feeble, squeaking voice, "Well, I hardly know--No more, thank ye. I\'m better now--all I know is, something comes at me like a Jack-in-the-box and up I goes like a sky-rocket!"',
            'After a minute or two of silence, they began moving about again, and Alice heard the Rabbit say, "A barrowful will do, to begin with."',
            '"A barrowful of _what_?" thought Alice.',
            ...
            '"If I eat one of these cakes," she thought, "it\'s sure to make _some_ change in my size."',
            ...
            "They all made a rush at Alice the moment she appeared, but she ran off as hard as she could and soon found herself safe in a thick wood.",
            '"The first thing I\'ve got to do," said Alice to herself, as she wandered about in the wood, "is to grow to my right size again; and the second thing is to find my way into that lovely garden. I suppose I ought to eat or drink something or other, but the great question is \'What?\'"',
            "Alice looked all around her at the flowers and the blades of grass, but she could not see anything that looked like the right thing to eat or drink under the circumstances.",
            ...
            '"Explain yourself!"',
            '"I can\'t explain _myself_, I\'m afraid, sir," said Alice, "because I\'m not myself, you see--being so many different sizes in a day is very confusing."',
            'She drew herself up and said very gravely, "I think you ought to tell me who _you_ are, first."',
            '"Why?" said the Caterpillar.',
            "As Alice could not think of any good reason and the Caterpillar seemed to be in a _very_ unpleasant state of mind, she turned away.",
            ...
            '"What size do you want to be?" asked the Caterpillar.',
            '"Oh, I\'m not particular as to size," Alice hastily replied, "only one doesn\'t like changing so often, you know. I should like to be a _little_ larger, sir, if you wouldn\'t mind," said Alice.',
            ...
            "She was a good deal frightened by this very sudden change, as she was shrinking rapidly; so she set to work at once to eat some of the other bit.",
            ...
            '"Come, my head\'s free at last!" said Alice; but all she could see, when she looked down, was an immense length of neck, which seemed to rise like a stalk out of a sea of green leaves that lay far below her.',
            '"Where _have_ my shoulders got to? And oh, my poor hands, how is it I can\'t see you?"',
            "She was delighted to find that her neck would bend about easily in any direction, like a serpent.",
            "She had just succeeded in curving it down into a graceful zigzag and was going to dive in among the leaves, when a sharp hiss made her draw back in a hurry--a large pigeon had flown into her face and was beating her violently with its wings.",
            '"Serpent!" cried the Pigeon.',
            ...
            "Alice was more and more puzzled.",
            '"As if it wasn\'t trouble enough hatching the eggs," said the Pigeon, "but I must be on the look-out for serpents, night and day! And just as I\'d taken the highest tree in the wood," continued the Pigeon, raising its voice to a shriek, "and just as I was thinking I should be free of them at last, they must needs come wriggling down from the sky! Ugh, Serpent!"',
            '"But I\'m _not_ a serpent, I tell you!" said Alice.',
            "\"I'm a--I'm a--I'm a little girl,\" she added rather doubtfully, as she remembered the number of changes she had gone through that day.",
            '"You\'re looking for eggs, I know _that_ well enough," said the Pigeon; "and what does it matter to me whether you\'re a little girl or a serpent?"',
            '"It matters a good deal to _me_," said Alice hastily; "but I\'m not looking for eggs, as it happens, and if I was, I shouldn\'t want _yours_--I don\'t like them raw."',
            ...
            "After awhile she remembered that she still held the pieces of mushroom in her hands, and she set to work very carefully, nibbling first at one and then at the other, and growing sometimes taller and sometimes shorter, until she had succeeded in bringing herself down to her usual height.",
            "It was so long since she had been anything near the right size that it felt quite strange at first.",
            '"The next thing is to get into that beautiful garden--how _is_ that to be done, I wonder?"',
            "As she said this, she came suddenly upon an open place, with a little house in it about four feet high.",
            '"Whoever lives there," thought Alice, "it\'ll never do to come upon them _this_ size; why, I should frighten them out of their wits!"',
            "She did not venture to go near the house till she had brought herself down to nine inches high.",
            "VI--PIG AND PEPPER",
            ...
            'The Fish-Footman began by producing from under his arm a great letter, and this he handed over to the other, saying, in a solemn tone, "For the Duchess. An invitation from the Queen to play croquet."',
            ...
            "When Alice next peeped out, the Fish-Footman was gone, and the other was sitting on the ground near the door, staring stupidly up into the sky.",
            ...
            "The only two creatures in the kitchen that did _not_ sneeze were the cook and a large cat, which was grinning from ear to ear.",
            '"Please would you tell me," said Alice, a little timidly, "why your cat grins like that?"',
            '"It\'s a Cheshire-Cat," said the Duchess, "and that\'s why."',
            "\"I didn't know that Cheshire-Cats always grinned; in fact, I didn't know that cats _could_ grin,\" said Alice.",
            '"You don\'t know much," said the Duchess, "and that\'s a fact."',
            "Just then the cook took the caldron of soup off the fire, and at once set to work throwing everything within her reach at the Duchess and the baby--the fire-irons came first; then followed a shower of saucepans, plates and dishes.",
            ...
            "She said the last words out loud and the little thing grunted in reply.",
            '"If you\'re going to turn into a pig, my dear," said Alice, "I\'ll have nothing more to do with you. Mind now!"',
            'Alice was just beginning to think to herself, "Now, what am I to do with this creature, when I get it home?" when it grunted again so violently that Alice looked down into its face in some alarm.',
            "This time there could be _no_ mistake about it--it was neither more nor less than a pig; so she set the little creature down and felt quite relieved to see it trot away quietly into the wood.",
            ...
            '"I do," Alice hastily replied; "at least--at least I mean what I say--that\'s the same thing, you know."',
            "\"You might just as well say,\" added the Dormouse, which seemed to be talking in its sleep, \"that 'I breathe when I sleep' is the same thing as 'I sleep when I breathe!'\"",
            '"It _is_ the same thing with you," said the Hatter, and he poured a little hot tea upon its nose.',
            ...
            "The Dormouse fell asleep instantly and neither of the others took the least notice of her going, though she looked back once or twice; the last time she saw them, they were trying to put the Dormouse into the tea-pot.",
            ...
            "Taking the little golden key, she unlocked the door that led into the garden.",
            "Then she set to work nibbling at the mushroom (she had kept a piece of it in her pocket) till she was about a foot high; then she walked down the little passage; and _then_--she found herself at last in the beautiful garden, among the bright flower-beds and the cool fountains.",
            "VIII--THE QUEEN'S CROQUET GROUND",
            ...
            "First came ten soldiers carrying clubs, with their hands and feet at the corners: next the ten courtiers; these were ornamented all over with diamonds.",
            "After these came the royal children; there were ten of them, all ornamented with hearts.",
            "Next came the guests, mostly Kings and Queens, and among them Alice recognized the White Rabbit.",
            "Then followed the Knave of Hearts, carrying the King's crown on a crimson velvet cushion; and last of all this grand procession came THE KING AND THE QUEEN OF HEARTS.",
            ...
            'The players all played at once, without waiting for turns, quarrelling all the while and fighting for the hedgehogs; and in a very short time, the Queen was in a furious passion and went stamping about and shouting, "Off with his head!" or "Off with her head!" about once in a minute.',
            '"They\'re dreadfully fond of beheading people here," thought Alice; "the great wonder is that there\'s anyone left alive!"',
            "She was looking about for some way of escape, when she noticed a curious appearance in the air.",
            '"It\'s the Cheshire-Cat," she said to herself; "now I shall have somebody to talk to."',
            '"How are you getting on?" said the Cat.',
            '"I don\'t think they play at all fairly," Alice said, in a rather complaining tone; "and they all quarrel so dreadfully one can\'t hear oneself speak--and they don\'t seem to have any rules in particular."',
            '"How do you like the Queen?" said the Cat in a low voice.',
            '"Not at all," said Alice.',
            ...
            "She was a little startled, however, when she heard the voice of the Duchess close to her ear.",
            '"You\'re thinking about something, my dear, and that makes you forget to talk."',
            '"The game\'s going on rather better now," Alice said, by way of keeping up the conversation a little.',
            "\"'Tis so,\" said the Duchess; \"and the moral of that is--'Oh, 'tis love, 'tis love that makes the world go 'round!'\"",
            '"Somebody said," Alice whispered, "that it\'s done by everybody minding his own business!"',
            '"Ah, well! It means much the same thing," said the Duchess, digging her sharp little chin into Alice\'s shoulder, as she added "and the moral of _that_ is--\'Take care of the sense and the sounds will take care of themselves.\'"',
            "To Alice's great surprise, the Duchess's arm that was linked into hers began to tremble.",
            "Alice looked up and there stood the Queen in front of them, with her arms folded, frowning like a thunderstorm!",
            '"Now, I give you fair warning," shouted the Queen, stamping on the ground as she spoke, "either you or your head must be off, and that in about half no time. Take your choice!"',
            "The Duchess took her choice, and was gone in a moment.",
            '"Let\'s go on with the game," the Queen said to Alice; and Alice was too much frightened to say a word, but slowly followed her back to the croquet-ground.',
            'All the time they were playing, the Queen never left off quarreling with the other players and shouting, "Off with his head!" or "Off with her head!"',
            "By the end of half an hour or so, all the players, except the King, the Queen and Alice, were in custody of the soldiers and under sentence of execution.",
            "Then the Queen left off, quite out of breath, and walked away with Alice.",
            'Alice heard the King say in a low voice to the company generally, "You are all pardoned."',
            'Suddenly the cry "The Trial\'s beginning!" was heard in the distance, and Alice ran along with the others.',
            "IX--WHO STOLE THE TARTS?",
            ...
            "The judge, by the way, was the King and he wore his crown over his great wig.",
            ...
            '"Fourteenth of March, I _think_ it was," he said.',
            '"Give your evidence," said the King, "and don\'t be nervous, or I\'ll have you executed on the spot."',
            "This did not seem to encourage the witness at all; he kept shifting from one foot to the other, looking uneasily at the Queen, and, in his confusion, he bit a large piece out of his teacup instead of the bread and butter.",
            "Just at this moment Alice felt a very curious sensation--she was beginning to grow larger again.",
            ...
            "X--ALICE'S EVIDENCE",
            '"Here!" cried Alice.',
            "She jumped up in such a hurry that she tipped over the jury-box, upsetting all the jurymen on to the heads of the crowd below.",
            '"Oh, I _beg_ your pardon!" she exclaimed in a tone of great dismay.',
            '"The trial cannot proceed," said the King, "until all the jurymen are back in their proper places--_all_," he repeated with great emphasis, looking hard at Alice.',
            '"What do you know about this business?" the King said to Alice.',
            '"Nothing whatever," said Alice.',
            ...
            '"This paper has just been picked up. It seems to be a letter written by the prisoner to--to somebody."',
            "He unfolded the paper as he spoke and added, \"It isn't a letter, after all; it's a set of verses.\"",
            '"Please, Your Majesty," said the Knave, "I didn\'t write it and they can\'t prove that I did; there\'s no name signed at the end."',
            '"You _must_ have meant some mischief, or else you\'d have signed your name like an honest man," said the King.',
            ...
            "Nobody moved.",
            '"Who cares for _you_?" said Alice (she had grown to her full size by this time).',
            '"You\'re nothing but a pack of cards!"',
            "At this, the whole pack rose up in the air and came flying down upon her; she gave a little scream, half of fright and half of anger, and tried to beat them off, and found herself lying on the bank, with her head in the lap of her sister, who was gently brushing away some dead leaves that had fluttered down from the trees upon her face.",
            '"Wake up, Alice dear!" said her sister.',
            '"Why, what a long sleep you\'ve had!"',
            '"Oh, I\'ve had such a curious dream!" said Alice.',
            "And she told her sister, as well as she could remember them, all these strange adventures of hers that you have just been reading about.",
